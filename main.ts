...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorOpenSouth, function (sprite, location) {
    music.play(music.createSoundEffect(WaveShape.Noise, 3300, 1400, 145, 0, 1200, SoundExpressionEffect.Warble, InterpolationCurve.Linear), music.PlaybackMode.UntilDone)
    ...
    if (made_the_jump) {
        ...
        for (let value of tiles.getTilesByType(tileUtil.object6)) {
        ...
        tiles.placeOnTile(mySprite, tiles.getTileLocation(14, 38))
        fourth_room = true
        third_room = false
        second_room = false
    }
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (mySprite.tileKindAt(TileDirection.Top, sprites.dungeon.purpleSwitchUp)) {
        if (sword_not_recieved) {
            music.play(music.melodyPlayable(music.buzzer), music.PlaybackMode.InBackground)
            game.showLongText("Maybe I should see what's in that chest first", DialogLayout.Bottom)
        }
        if (Sword_recieved) {
            tiles.setCurrentTilemap(tilemap`level1`)
            music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.InBackground)
            game.showLongText("You opened the door!", DialogLayout.Bottom)
        }
    }
    if (!(third_room)) {
        if (mySprite.tileKindAt(TileDirection.Left, sprites.dungeon.chestClosed) || mySprite.tileKindAt(TileDirection.Right, sprites.dungeon.chestClosed) || (mySprite.tileKindAt(TileDirection.Top, sprites.dungeon.chestClosed) || mySprite.tileKindAt(TileDirection.Bottom, sprites.dungeon.chestClosed))) {
            tiles.setCurrentTilemap(tilemap`level0`)
            game.setDialogTextColor(5)
            music.play(music.melodyPlayable(music.powerUp), music.PlaybackMode.InBackground)
            game.showLongText("You found an old sword and shield!", DialogLayout.Bottom)
            game.setDialogTextColor(15)
            Sword_recieved = true
            sword_not_recieved = false
        }
    }
    if (third_room) {
        if (mySprite.tileKindAt(TileDirection.Left, sprites.dungeon.chestClosed) || mySprite.tileKindAt(TileDirection.Right, sprites.dungeon.chestClosed) || (mySprite.tileKindAt(TileDirection.Top, sprites.dungeon.chestClosed) || mySprite.tileKindAt(TileDirection.Bottom, sprites.dungeon.chestClosed))) {
            ...
            game.setDialogTextColor(5)
            music.play(music.melodyPlayable(music.powerUp), music.PlaybackMode.InBackground)
            game.showLongText("You found a manual on how to jump maybe by pressing B I can jump across that gap", DialogLayout.Bottom)
            game.setDialogTextColor(15)
            jump_acquired = true
        }
    }
    if (second_room) {
        if (jump_acquired) {
            if (jumpcan) {
                game.showLongText("Here goes nothing if I fall ill probably die..", DialogLayout.Bottom)
                ...
                made_the_jump = true
                if (made_the_jump) {
                    game.showLongText("Phew almost thought I fell there!", DialogLayout.Bottom)
                }
                ...
                if (mySprite.tileKindAt(TileDirection.Center, sprites.dungeon.hazardHole)) {
                    game.gameOver(false)
                    game.setGameOverEffect(false, effects.dissolve)
                    game.setGameOverPlayable(false, music.melodyPlayable(music.wawawawaa), false)
                    pause(5000)
    ...
    if (fourth_room) {
        if (mySprite.tileKindAt(TileDirection.Left, sprites.dungeon.chestClosed) || mySprite.tileKindAt(TileDirection.Right, sprites.dungeon.chestClosed) || (mySprite.tileKindAt(TileDirection.Top, sprites.dungeon.chestClosed) || mySprite.tileKindAt(TileDirection.Bottom, sprites.dungeon.chestClosed))) {
            tiles.setTileAt(tiles.getTileLocation(2, 5), sprites.dungeon.chestOpen)
            game.setDialogTextColor(5)
            music.play(music.melodyPlayable(music.powerUp), music.PlaybackMode.InBackground)
    ...
    if (second_room) {
        if (mySprite.tileKindAt(TileDirection.Top, sprites.dungeon.doorLockedNorth)) {
            tiles.setTileAt(tiles.getTileLocation(2, 5), sprites.dungeon.doorOpenNorth)
            game.setDialogTextColor(5)
            music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.InBackground)
            game.showLongText("You opened the door!", DialogLayout.Bottom)
            game.setDialogTextColor(15)
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorOpenNorth, function (sprite, location) {
    ...
    if (door_unlocked) {
        ...
        music.play(music.createSong(hex``), music.PlaybackMode.UntilDone)
        game.setDialogFrame(img`
            ...
            ..........................................
            `)
        game.showLongText("You escaped and went on to live a prosperous life", DialogLayout.Bottom)
        game.gameOver(true)
...
let Keyfound = false
let jumpcan = false
let jump_acquired = false
let myEnemy: Sprite = null
let made_the_jump = false
let second_room = false
let third_room = false
let fourth_room = false
let facing_right = false
let facing_left = false
let facing_down = false
let facing_up = false
let Sword_recieved = false
let mySprite: Sprite = null
let sword_not_recieved = false
let jumptext = true
sword_not_recieved = true
...
game.showLongText("You have awoken", DialogLayout.Bottom)
game.showLongText("Welcome to..", DialogLayout.Bottom)
game.showLongText("The Dungeon", DialogLayout.Bottom)
music.stopAllSounds()
...
game.onUpdate(function () {
    for (let enemy of sprites.allOfKind(SpriteKind.Enemy)) {
        if (Math.abs(enemy.x - mySprite.x) < 80) {
...
forever(function () {
    if (jumptext) {
        if (mySprite.tileKindAt(TileDirection.Bottom, sprites.dungeon.floorDark4)) {
            game.showLongText("That gap looks like it goes down pretty deep", DialogLayout.Bottom)
            jumptext = false
        }
    }
})
